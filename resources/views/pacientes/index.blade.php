...
@section('contenido')
                ...
                <tbody>
                    @forelse($pacientes as $paciente)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="table-cell text-center flex justify-center gap-1 flex-wrap">
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="table-empty text-center py-4">No hay pacientes registrados.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Confirmación para asignar cama
