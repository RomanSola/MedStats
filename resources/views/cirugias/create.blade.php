...
@section('contenido')
    <div class="max-w-full px-4 py-4">
        <h2
             class="text-danger fw-bold border-bottom border-danger pb-2 mb-4">
                ...
                <form action="{{ route('cirugias.store') }}" method="POST">
                    ...
                    <div class="row mb-3 ">
                        <div class="col-md-4">
                            ...
                            <select name="paciente_id" id="paciente_id" class="form-control border-danger">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control border-danger" name="procedimiento_id" id="procedimiento_id" class="form-control">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="quirofano_id" id="quirofano_id" class="form-control border-danger">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="cirujano_id" id="cirujano_id" class="form-control border-danger">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="ayudante_1_id" id="ayudante_1_id" class="form-control border-danger">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="ayudante_2_id" id="ayudante_2_id" class="form-control border-danger">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="ayudante_3_id" id="ayudante_3_id" class="form-control border-danger">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="anestesista_id" id="anestesista_id" class="form-control border-danger">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="tipo_anestesia_id" id="tipo_anestesia_id" class="form-control border-danger">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="instrumentador_id" id="instrumentador_id" class="form-control border-danger">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="enfermero_id" id="enfermero_id" class="form-control border-danger">
