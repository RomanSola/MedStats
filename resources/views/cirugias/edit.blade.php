                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            @error('instrumentador_id')
                                <small class="teinstrumentador_idxt-danger"> {{ $message }} </small>
                            @enderror
                        </div>

                        <div class="col-md-4">
                            <label for="urgencia" class="form-label">Urgencia</label>
                            <input type="checkbox" name="urgencia" id="urgencia" class="form-control" value="1" {{ $cirugia->urgencia ? 'checked' : '' }}>   
                        </div>
                        @error('urgencia')
                            <small class="text-danger"> {{ $message }} </small>
                        @enderror
