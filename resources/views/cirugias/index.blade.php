...
@section('contenido')
    <div class="max-80  mx-auto px-4 py-8">
                                    ...
                                    <tbody>
                                        @forelse($cirugias as $cirugia)
                                            <tr>
                                                ...
                                                <td>{{ $cirugia->get_paciente->nombre }}
                                                    {{ $cirugia->get_paciente->apellido }}</td>
                                                <td>{{ $cirugia->get_procedimiento->nombre_procedimiento }}</td>
                                                <td>{{ $cirugia->get_cirujano->nombre }}
                                                    {{ $cirugia->get_cirujano->apellido }}</td>
                                                <td class="no-print">{{ $cirugia->get_ayudante1->nombre ?? '-' }}
                                                    {{ $cirugia->get_ayudante1->apellido ?? '' }}</td>
                                                <td class="no-print">{{ optional($cirugia->get_ayudante2)->nombre ?? '-' }}
                                                    {{ optional($cirugia->get_ayudante2)->apellido ?? '' }}</td>
                                                <td>{{ $cirugia->get_anestesista->nombre }}
                                                    {{ $cirugia->get_anestesista->apellido }}</td>
                                                <td>{{ optional($cirugia->get_instrumentador)->nombre }}
                                                    {{ optional($cirugia->get_instrumentador)->apellido }}</td>
                                                <td>{{ optional($cirugia->get_enfermero)->nombre }}
                                                    {{ optional($cirugia->get_enfermero)->apellido }}</td>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="12" class="text-center text-muted">No hay cirugías
                                                    registradas
                                                    aún.
                                                </td>
                                            </tr>
