...
<center>
    ...
    <br>
    <h1 style="font-size: 24px; color: #333; font-weight: bold;">Datos Personales</h1>
    <br>
    <div style="width: 60%; padding: 20px; border: 1px solid #ccc; border-radius: 5px; background-color:#c9c9c9;">
        {{-- Si hay detalle de una persona --}}
        @if(isset($persona))
            <h1 style="font-size: 24px; color: #; font-weight: bold; border-bottom: 2px solid #333;">
                {{ $persona->apellido }}, {{ $persona->nombre }}
            </h1>
    </div>

    <div style="width: 60%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; background-color:#c9c9c9;">
        DNI: {{ $persona->dni }}
        <br>
    ...
    <br>
    <h1 style="font-size: 24px; color: #333; font-weight: bold;">Historial de Medicamentos</h1>
    <br>
