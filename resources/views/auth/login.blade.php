        ...
        <div class="relative w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden z-10">
            ...
            <div class="p-8 space-y-6">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <!-- Botón Login -->
                    <div class="mt-4">
                        <x-primary-button class="w-full py-3 text-lg font-semibold rounded-xl bg-[#1B7D8F] hover:bg-[#176d7b] transition-all duration-300 text-white shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                            {{ __('Log in') }}
                        </x-primary-button>
                    </div>
