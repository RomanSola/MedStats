<header class="bg-white shadow-md border-b border-[#B4DCE2]">
  <div class="max-w-7xl mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
    ...
    <div class="flex items-center justify-center gap-2 md:gap-4 flex-wrap">
      ...
      <div class="text-center">
        <h1 class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-[#1B7D8F] via-[#2BA8A0] to-[#245360] text-transparent bg-clip-text drop-shadow-md tracking-widest whitespace-nowrap">
          Hospital San Felipe
        </h1>
        <p class="text-sm text-[#4B6C73] tracking-wider uppercase mt-1">
  ...
  <div class="flex items-center gap-3 flex-shrink-0">
    ...
    <a href="{{ route('ajustes') }}"
      class="bg-[#1B7D8F] hover:bg-[#176d7b] text-white text-sm px-4 py-2 rounded-md shadow transition">
      ⚙️ @lang('Ajustes')
    </a>
