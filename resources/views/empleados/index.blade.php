                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('empleados.show', $empleado) }}" class="btn btn-outline-primary btn-sm me-1">Ver</a>
                                <a href="{{ route('empleados.edit', $empleado) }}" class="btn btn-outline-warning btn-sm me-1">Editar</a>
                                <form action="{{ route('empleados.destroy', $empleado) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn btn-outline-danger btn-sm" onclick="return confirm('¿Estás seguro de que querés eliminar este empleado?')">Eliminar</button>
                                </form>
                            </td>
                        </tr>
                        @empty
