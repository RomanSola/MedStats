    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <form action="{{ route('stocks.update', $stock) }}" method="POST"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @if ($modo === 'agregar')
                    <div>
                        <label for="cantidad_agregar" class="block text-sm font-medium text-gray-700 mb-1">Agregar
                            Cantidad</label>
                ...
                @elseif ($modo === 'extraer')
                    <div>
                        <label for="cantidad_extraer" class="block text-sm font-medium text-gray-700 mb-1">Extraer
                            Cantidad</label>
            ...
            @if ($modo === 'extraer')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="paciente_id" class="block text-sm font-medium text-gray-700 mb-1">El medicamento es
                            para</label>
